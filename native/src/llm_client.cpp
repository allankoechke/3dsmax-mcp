...
static const ChatTool kChatTools[] = {
    ...
    {"get_object_properties", "native:get_object_properties", "Compact object properties by name", "{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"}},\"required\":[\"name\"]}"},
    ...
    {"inspect_object",        "native:inspect_object",    "Deep exploratory object summary", "{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"}},\"required\":[\"name\"]}"},
    ...
    {"inspect_material_network","native:inspect_material_network","Semantic material graph and texture manifest", "{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"},\"sub_material_index\":{\"type\":\"integer\"},\"depth\":{\"type\":\"integer\"},\"scope\":{\"type\":\"string\"},\"include_values\":{\"type\":\"boolean\"},\"verify_files\":{\"type\":\"boolean\"},\"max_nodes\":{\"type\":\"integer\"},\"profile\":{\"type\":\"string\"},\"compact\":{\"type\":\"boolean\"}},\"required\":[\"name\"]}"},
    {"replicate_material",    "native:replicate_material","Preview/apply material graph clone and texture remap", "{\"type\":\"object\",\"properties\":{\"source\":{\"type\":\"string\"},\"target\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}},\"mode\":{\"type\":\"string\"},\"texture_folder\":{\"type\":\"string\"},\"path_map\":{\"type\":\"object\"},\"assign\":{\"type\":\"boolean\"},\"preview\":{\"type\":\"boolean\"},\"verify\":{\"type\":\"boolean\"},\"allow_missing\":{\"type\":\"boolean\"}},\"required\":[\"source\",\"target\"]}"},
